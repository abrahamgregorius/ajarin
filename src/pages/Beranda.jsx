  ...
  const articles = [
    {
      ...
      excerpt:
        "Pelajari cara belajar matematika yang menyenangkan dan efektif untuk meningkatkan pemahaman konsep...",
    ...
    },
    {
      ...
      excerpt:
        "Dalam era digital saat ini, literasi digital menjadi keterampilan penting yang harus dikuasai oleh setiap siswa...",
      category: "Teknologi",
      readTime: "7 min",
      image: "💻",
    },
    {
      ...
      excerpt:
        "IPA sering dianggap sulit, namun dengan metode yang tepat, pelajaran ini bisa menjadi menarik dan mudah dipahami...",
      category: "Tips Belajar",
      readTime: "6 min",
      image: "🔬",
    },
    {
      ...
      excerpt:
        "Belajar bukan hanya tentang nilai, tapi juga tentang menemukan passion dan minat yang sesungguhnya...",
      category: "Motivasi",
      readTime: "4 min",
      image: "🎯",
    },
    {
      ...
      excerpt:
        "Strategi persiapan menghadapi ujian nasional yang efektif dan efisien untuk mencapai hasil maksimal...",
        ...
        <div className="bg-linear-to-br from-blue-500 via-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg">
          <div className="text-left">
            <h1 className="text-2xl font-bold mb-1">
              {getTimeBasedGreeting()}, {user?.name || "Pengguna"}
            </h1>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-4">
              <div className="flex items-center justify-center space-x-2 mb-2">
                <Flame
                  size={20}
                  className={
                    hasCompletedToday ? "text-orange-400" : "text-white/60"
                  }
                />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg text-center">
              ...
              <p className="text-sm font-medium text-gray-900">
                {highlightsLoading
                  ? "..."
                  : `${todaysHighlights.activeStudents}+ Siswa`}
              </p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg text-center">
              ...
              <p className="text-sm font-medium text-gray-900">
                {highlightsLoading
                  ? "..."
                  : `${todaysHighlights.totalStudyHours * 60} menit`}
              </p>
