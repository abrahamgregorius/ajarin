            ...
            <div className="p-6 flex items-center justify-center min-h-[calc(100vh-73px)]">
                <div className="bg-white rounded-xl shadow-sm w-full max-w-md p-6">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-gray-600 text-sm">Belum punya akun? <a href="#" className="text-blue-600 font-medium hover:text-blue-800">Daftar sekarang</a></p>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-4 grid grid-cols-2 gap-3">
                            <button className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
