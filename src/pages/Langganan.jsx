...
export default function Subscription() {
    const plans = [
        ...
        },
        {
            ...
            popular: true,
            color: 'border-blue-400 bg-blue-50 ring-4 ring-blue-200',
    ...
    return (
        <>
            <SafeArea className="p-3 bg-blue-50 min-h-screen">
                ...
                <div className="current-plan mb-8 bg-blue-500 p-6 rounded-2xl text-white shadow-xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {plans.map(plan => (
                            <div key={plan.name} className={`rounded-2xl shadow-xl p-6 border-4 relative transform hover:scale-105 transition-all duration-300 ${plan.color}`}>
                                ...
                                <button className={`w-full py-4 rounded-xl font-bold text-base transition-all transform hover:scale-105 shadow-lg text-white ${plan.buttonColor} ${plan.name === currentPlan
                ...
                <div className="achievements mb-8 bg-yellow-100 p-6 rounded-2xl shadow-xl">
                    <div className="text-center mb-4">
                        <svg className="w-12 h-12 text-yellow-600 mx-auto mb-2" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                        <h2 className="text-xl font-bold text-gray-800 mb-2">Pencapaian Belajar</h2>
                        <p className="text-gray-600 text-sm">Kamu sudah belajar dengan baik!</p>
                    </div>
                    <div className="grid grid-cols-3 gap-4 text-center">
                        <div className="bg-white/60 p-3 rounded-xl">
                            <svg className="w-6 h-6 text-yellow-600 mx-auto mb-1" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z" />
                            </svg>
                            <p className="font-bold text-sm text-gray-800">25 Kursus</p>
                            <p className="text-xs text-gray-600">Diselesaikan</p>
                        </div>
                        <div className="bg-white/60 p-3 rounded-xl">
                            <svg className="w-6 h-6 text-yellow-600 mx-auto mb-1" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                            </svg>
                            <p className="font-bold text-sm text-gray-800">150 Poin</p>
                            <p className="text-xs text-gray-600">Didapatkan</p>
                        </div>
                        <div className="bg-white/60 p-3 rounded-xl">
                            <svg className="w-6 h-6 text-yellow-600 mx-auto mb-1" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z" />
                ...
                <div className="faq-section">
                    ...
                    <div className="space-y-4">
                        <div className="bg-blue-50 p-5 rounded-2xl shadow-lg border-2 border-blue-200">
                        ...
                        <div className="bg-green-50 p-5 rounded-2xl shadow-lg border-2 border-green-200">
                            <h3 className="font-bold text-gray-800 mb-2 text-base flex items-center">
                        ...
                        <div className="bg-purple-50 p-5 rounded-2xl shadow-lg border-2 border-purple-200">
                            <h3 className="font-bold text-gray-800 mb-2 text-base flex items-center">
